...
import { Search, ChevronLeft, ChevronRight, Play, Award, Rocket, FileText, ArrowRight, PhoneCall, Mail, MessageSquare } from 'lucide-react';
        ...
        <div className="myshine-main-2col-layout">
          ...
          <div className="myshine-right-sidebar">
            <div className="sidebar-profile-gauge-card">
              ...
              <button className="btn-purple-block" onClick={() => onNavigate('profile-view')}>
                View / Update Profile
              </button>
            </div>
